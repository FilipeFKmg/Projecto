...
Search strategy:
    ...
    - Family deduplication: across all queries and all years, only one
      ...
      jurisdictions (EP > US > WO > CA > GB > IE > AU > NZ).
...
# 
# Priority logic: 
# 1  : Prioritizing EP since the EPO has it in OPS database.
# 2  : Prioritizing US for future recollection in the US patent office.
# 3+ : Remaining jurisdictions ranked by full-text and XML availability.
# =============================================================================
COUNTRY_PRIORITY = {
